...
<body>
          <form action="searchProperty" method="post">
			<header>
				...
				<nav class="nav-bar">
					<a href="dash">Home</a> <a href="Getproperty">Buy</a> <a href="PropertyRegister">Sell</a> <a
						href="#footer">About</a>
				</nav>
		...
		<main>
       <c:if test="${empty searchInfo}"></c:if>
			<div class="property-container">
				<div class="property">
					<img
						src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuysYuK0mt3MvIji_ixI6m8vKuJRMn2Sg-Vw&s"
						alt="property image" class="image">
					<div class="property-details">
						<p class="property-title">
							Property Name : <span class="property-info">Bunglow</span>
						</p>
						<p class="property-title">
							Price : <span class="property-info">15,00,000</span>
						</p>
						<p class="property-title">
							City : <span class="property-info">Mumbai</span>
						</p>
						<p class="property-title">
							Property Status : <span class="property-info">Sell</span>
						</p>
						<p class="property-title">
							Property Type : <span class="property-info">Bunglow</span>
						</p>
						<p class="property-title">
							Property Sub-Type : <span class="property-info">1 BHK</span>
						</p>
...
<div class="property">
      ...
      <div class="property-details">
       ...
       <div class="btn"><a href="singleProperty/${p.pid}" ><button class="exp-btn">Explore Now</button></a></div>
      </div>
      </div>
      </c:forEach>
</div>
